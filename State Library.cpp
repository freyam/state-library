...
public:
    void createcustomer() {
        cout << endl;
        cout << "Customer Registration Number: ";
        cin >> regno;
        cout << endl;
        cout << "Customer Name: ";
        cin.get();
...
void searchbybno() {
    ...
    cout << "Book Number to be Searched: ";
    cin >> no;

    f.open("Books.dat", ios::in);
    while (f.read((char *)&bk, sizeof(book))) {
        if (strcmp(bk.getbno(), no) == 0) {
            bk.showbook();
            flag = 1;
        }
    }
...
void searchbybname() {
    ...
    cout << "Book Name to be Searched: ";
    cin.get();
    cin.getline(name, 20);

    f.open("Books.dat", ios::in);
    while (f.read((char *)&bk, sizeof(book))) {
        if (strcmp(bk.getbname(), name) == 0) {
            bk.showbook();
            flag = 1;
        }
    }
...
void modifybook() {
    ...
    cout << "Book Number to be Modified: ";
    cin >> no;
...
void deletebook() {
    ...
    cout << "Book Number to be Deleted: ";
    cin >> no;
...
void searchbyregno() {
    ...
    cout << "Customer's Registration Number to be Searched: ";
    cin >> no;

    f.open("Customers.dat", ios::in);
    while (f.read((char *)&ct, sizeof(customer))) {
        if (strcmp(ct.getregno(), no) == 0) {
            ct.showcustomer();
            flag = 1;
        }
    }
    ...
    if (flag == 0)
        cout << "This Customer Doesn't Exist!";
...
void searchbyname() {
    ...
    cout << "Customer Name to be Searched: ";
    cin.get();
    cin.getline(name, 20);

    f.open("Customers.dat", ios::in);
    while (f.read((char *)&ct, sizeof(customer))) {
        if (strcmp(ct.getname(), name) == 0) {
            ct.showcustomer();
            flag = 1;
        }
    }
...
void modifycustomer() {
    ...
    cout << "Customer Number to be Modified: ";
    cin >> no;
...
void deletecustomer() {
    ...
    cout << "Customer Registration Number to be Deleted: ";
    cin >> no;
    ...
    while (f.read((char *)&ct, sizeof(customer)) && cflag == 0) {
        if (strcmp(ct.getregno(), cn) == 0) {
            ...
            if (ct.getbook_issued() == 0) {
                ...
                cout << "You Haven't Returned the Last Book Yet!";
        }
    }
    if (cflag == 0)
        cout << "This Customer Doesn't Exist!";
    ...
    while (f.read((char *)&ct, sizeof(customer)) && cflag == 0) {
        if (strcmp(ct.getregno(), cn) == 0) {
            ...
            if (ct.getbook_issued() == 1) {
                while (f1.read((char *)&bk, sizeof(book)) && bflag == 0) {
                    if (strcmp(bk.getbno(), ct.getcbno()) == 0) {
                        cout << endl
                             << ct.getname() << " returned Book No. " << bk.getbno() << " - " << bk.getbname();
                        bflag = 1;
                        ct.bookreturned();
                ...
                if (bflag == 0)
                    cout << "This Book Doesn't Exist or is Currently Unavailable!";
            } else
